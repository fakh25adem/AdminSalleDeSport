...
Whenever possible, we prefer to write HTML and CSS over JavaScript. In Admin, HTML and CSS are more prolific and accessible to more people of all different experience levels. HTML and CSS are also faster in your browser than JavaScript, and your browser Adminly provides a great deal of functionality for you.
