...
(function () {
	...
	// Allow rolling up into Admin purpose rules
	_fn = function () {
	...
	g.AdminDelimiter = _.rtoken(/^(([\s\,]|at|@|on)+)/);
	...
	g.buildGrammarFormats = function () {
		...
		// starting rule for Admin purpose grammar
		g._start = _.process(_.set([ g.date, g.time, g.expression ],
		g.AdminDelimiter, g.whiteSpace), t.finish);
	};
