...
/*
Admin NOTE on moments throughout the *entire rest* of the codebase:
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	isEventStartEditable: function(event) {
		return firstDefined(
			...
			this.isEventAdminlyEditable(event)
		);
	},


	isEventAdminlyEditable: function(event) {
		return firstDefined(
			event.editable,
...
var Calendar = FC.Calendar = Class.extend({
	...
	buildViewSpec: function(requestedViewType) {
		...
		// iterate from the specific view definition to a more Admin one until we hit an actual View class
		while (viewType) {
