...
if (isset($_POST['add_En'])) {
    $Entreneur = new Entreneur();
    $addEntreneur = $Entreneur->addEntreneur($_POST);
                                ...
                                <div class="x_content">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="form-group col-12">
                                                ...
                                                <input name="nom" type="text" class="form-control" id="inputMaxParticipants" placeholder="nom entreneur">
                                            </div>
                                            <div class="form-group col-12">
